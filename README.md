This project was developed as the final project for the [National Telecommunication Institute (NTI)](https://www.nti.sci.eg/) training program.

[Project Documentation.docx](https://github.com/user-attachments/files/30165840/Project.Documentation.docx)
...
-Store- VLAN 70, Network of 192.168.7.0/24 -Logistics- VLAN 60, Network of 192.168.6.0/24 2nd Floor;
-Finance- VLAN 50, Network of 192.168.5.0/24 -HR-VLAN 40, Network of 192.168.4.0/24 -Sales- VLAN 30, Network of 192.168.3.0/24 3rd Floor;
...
• In IT department, add PC called Test-PC to port fao/1 and use it to test remote login.
• Configure port security to IT-dept switch to allow only Test-PC to access port fao/1 (use sticky method to obtain mac-address with violation mode of shutdown.)
...
9. Configuring switchport security or Port-Security on the switches. 10. Configuring WLAN or wireless network (Cisco Access Point).
